...
public class MainFwActivity extends AppCompatActivity
    ...
    private LinearLayout rowLayoutShort, rowLayout0Short, rowLayout1Short, rowLayout2Short, rowLayout3Short;
    ...
    TextView tv, shopping_date,tv2;
    TextView all_Varieties_activate, tv_fareway_flag;
    LinearLayout liner_qty,liner_all_Varieties_activate, linear_shopping_list_tab, linear_coupon_tab, liner_detail_add_item, liner_add_sub_button;
    ...
    public static TextView offerTitle,offerTitle_search,search_keyword;
    public static TextView tv_location_title, tv_location_title_search;

    public static RelativeLayout linearLayout, linearLayout_search;

    private TextView changeStore, changeStore_search;
    ...
    public static RelativeLayout filter_offer_label;
    ...
    public static String offerTitle_search_string="";
    public static String search_keyword_string="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_offer_cross_button= findViewById(R.id.img_offer_cross_button);
        ...
        filter_offer_label= findViewById(R.id.filter_layout);
        ...
        linearLayout_search = findViewById(R.id.linear_personal_ad_lable_title_search);
        changeStore = findViewById(R.id.change_store);
        changeStore_search = findViewById(R.id.change_store_search);
        offerTitle = findViewById(R.id.tv_personal_lable_title);
        tv_location_title = findViewById(R.id.tv_location_title);

        offerTitle_search = findViewById(R.id.tv_personal_lable_title_search);
        search_keyword = findViewById(R.id.search_keyword);

        tv_location_title_search = findViewById(R.id.tv_location_title_search);
...
//        shopping_date=findViewById(R.id.shopping_date);
        ...
        search_reset = findViewById(R.id.search_reset);
        search_reset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setCheckIcon(SEARCH);
                offerTitle_search.setText("");
        ...
        liner_qty = findViewById(R.id.liner_qty);
...
//            String storeId = null;
    ...
    public void addBadgeView() {
        ...
        tv2 = badge.findViewById(R.id.notification_badge_2);
    ...
    private void linkUIElements() {
     ...
     /*   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
        ...
        customAdapterPersonalPrices = new CustomAdapterPersonalPrices(this, productList, this, this, this, this, this, this,this,this);
        //  RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(activity, 1);
        //  rv_items.setLayoutManager(mLayoutManager);
                            ...
                            public void onResponse(String response) {
                                ...
                                if (!response.equals("[]")) {
                                    try {
                                        ...
                                        message=jsonParam;
                                        */
                                        searchCount=jsonParam.length();

                                        offerTitle_search.setText("["+searchCount+"] Search Results");
                                        search_keyword.setText("Keywords: "+s);
                                        search_reset.setText(" Reset");

                                        ////
                                        offerTitle_search_string="["+searchCount+"] Search Results";
                                        search_keyword_string="Keywords: "+s;
                                        //
                                        message3 = jsonParam;
...
//                displayAlert();
        ...
        if (product.getPrimaryOfferTypeId() == 3) {
            ...
            if (product.getClickCount() > 0) {
                circular_layout_detaile.setBackground(getResources().getDrawable(R.drawable.activated));
            ...
            if (product.getIsFamily().equalsIgnoreCase("false")){
           ...
           /* try {
            ...
            try {
                ...
                if (formattedStringAdPrice.equalsIgnoreCase("0.00") || formattedStringAdPrice.equalsIgnoreCase(formattedStringRegularPrice)){
                    ...
                    float FloatFinalPrice = Float.parseFloat(product.getFinalPrice() + "f");
        ...
        /*        imv_status_detaile.setVisibility(View.VISIBLE);
            ...
            /*if (product.getRequiresActivation().equalsIgnoreCase("false")){
                ...
                String displayPrice1=product.getDisplayPrice().toString();
                if(product.getDisplayPrice().toString().split("\\.").length>1)
                    displayPrice1= product.getDisplayPrice().split("\\.")[0]+"<sup>"+ (product.getDisplayPrice().split("\\.")[1]).replace("<sup>","").replace("</sup>","")+"</sup>";
                Spanned result1 = Html.fromHtml(displayPrice1.replace("<sup>","<sup><small><small>").replace("</sup>","</small></small></sup>"));
                tv_price_detaile.setText(result1);
                tv_fareway_flag.setVisibility(View.GONE);
            }else {
                tv_fareway_flag.setVisibility(View.VISIBLE);
            }*/
...
//                displayAlert();
    ...
    @Override
    public void onReset(Product product) {
        setCheckIcon(SEARCH);
        offerTitle_search.setText("");
        search_keyword.setText("");
        search_reset.setText("");
    ...
    @Override
    public void onChangeStore(Product product) {
            Log.d(TAG, " >> memid " + appUtil.getPrefrence("MemberId"));
            LayoutInflater inflater = (LayoutInflater) MainFwActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View layout = inflater.inflate(R.layout.change_store_popup, null);
            window = new PopupWindow(MainFwActivity.this);
        ...
        if (relatedItem.getPrimaryOfferTypeId() == 3) {
            ...
            try {
                ...
                if (formattedStringAdPrice.equalsIgnoreCase("0.00") || formattedStringAdPrice.equalsIgnoreCase(formattedStringRegularPrice)){
                    ...
                    float FloatFinalPrice = Float.parseFloat(relatedItem.getFinalPrice() + "f");
                    float saving = (myFloatAdPrice-FloatFinalPrice);
                    String formattedsaving = String.format("%.02f", saving);
                    tv_save_detail.setText("$" + formattedsaving);
                }
                        ...
                        if (shopping.getPrimaryOfferTypeid() == 3) {
                           ...
                           /* String displayPrice = message.getJSONObject(i).getString("DisplayPrice");
                            ...
                            if (message.getJSONObject(i).getString("RewardType").equalsIgnoreCase("2") && message.getJSONObject(i).getInt("OfferDefinitionId") == 4) {
                                tv_price_detaile.setText("Buy " + message.getJSONObject(i).getInt("RequiredQty") + "\n" + "Get " + message.getJSONObject(i).getInt("RewardQty") + " " + result + "*");
                                ...
                                try {
                                    ...
                                    tv_price_detaile.setText("Buy " + message.getJSONObject(i).getInt("RequiredQty") + "\n" + "Get " + message.getJSONObject(i).getInt("RewardQty") + " $" + new DecimalFormat("##.##").format(reward_value) + " OFF*");
                            ...
                            String charsPackaging =lowercase(message.getJSONObject(i).getString("PackagingSize"));
                            if (message.getJSONObject(i).getString("IsFamily").equalsIgnoreCase("false")){
                                tv_detail_detail.setText(chars+" "+charsPackaging);
                            }else {
                                tv_detail_detail.setText(chars);
                            }
                            ...
                            try {
                                ...
                                if (formattedStringAdPrice.equalsIgnoreCase("0.00") || formattedStringAdPrice.equalsIgnoreCase(formattedStringRegularPrice)){
                                    ...
                                    float FloatFinalPrice = Float.parseFloat(message.getJSONObject(i).getString("FinalPrice") + "f");
                                    float saving = (myFloatAdPrice-FloatFinalPrice);
                                    String formattedsaving = String.format("%.02f", saving);
                                    tv_save_detail.setText("$" + formattedsaving);
                                }
                            ...
                            if (message.getJSONObject(i).getString("IsFamily").equalsIgnoreCase("True")){
                                liner_qty.setVisibility(View.GONE);
                                table_upc.setVisibility(View.GONE);
                                table_upc_view.setVisibility(View.GONE);
                            }
                           ...
                           /* String displayPrice = message.getJSONObject(i).getString("DisplayPrice").toString();
                            ...
                            if (message.getJSONObject(i).getString("IsStacked").equalsIgnoreCase("0")){
                                liner_qty.setVisibility(View.GONE);
                                table_upc.setVisibility(View.GONE);
                                table_upc_view.setVisibility(View.GONE);
                            }
                            if (message.getJSONObject(i).getString("IsStacked").equalsIgnoreCase("1")&&message.getJSONObject(i).getString("AdPrice").equalsIgnoreCase("0")){
                                liner_qty.setVisibility(View.GONE);
                                table_upc.setVisibility(View.GONE);
                                table_upc_view.setVisibility(View.GONE);
                            }
                                        ...
                                        try {
                                            ...
                                            for (int i = 0; i < jsonShoppingParam.length(); i++) {
                                                ...
                                                if (shopping.getPrimaryOfferTypeid() == 3) {
                                                    ...
                                                    if (jsonShoppingParam.getJSONObject(i).getString("IsFamily").equalsIgnoreCase("false")){
                                                        tv_detail_detail.setText(chars+" "+charsPackaging);
                                                    }else {
                                                        tv_detail_detail.setText(chars);
                                                    }
                                                    ...
                                                    if (jsonShoppingParam.getJSONObject(i).getString("IsFamily").equalsIgnoreCase("True")){
                                                        liner_qty.setVisibility(View.GONE);
                                                        table_upc.setVisibility(View.GONE);
                                                        table_upc_view.setVisibility(View.GONE);
                                                    }
                                                    ...
                                                    if (jsonShoppingParam.getJSONObject(i).getString("IsStacked").equalsIgnoreCase("0")){
                                                        liner_qty.setVisibility(View.GONE);
                                                        table_upc.setVisibility(View.GONE);
                                                        table_upc_view.setVisibility(View.GONE);
                                                    }
                                                    if (jsonShoppingParam.getJSONObject(i).getString("IsStacked").equalsIgnoreCase("1")&&jsonShoppingParam.getJSONObject(i).getString("AdPrice").equalsIgnoreCase("0")){
                                                        liner_qty.setVisibility(View.GONE);
                                                        table_upc.setVisibility(View.GONE);
                                                        table_upc_view.setVisibility(View.GONE);
                                                    }
...
//flagsearch
    ...
    public void activatedOffersListMainLoad() {
        if (ConnectivityReceiver.isConnected(activity) != NetworkUtils.TYPE_NOT_CONNECTED) {
            try {
                /*progressDialog = new ProgressDialog(activity);
                progressDialog.setMessage("Processing");
                                ...
                                try {
                                    ...
                                    if (root.getString("errorcode").equals("0")) {
                                        ...
                                        if (activatedOffer == null) {
                                            ...
                                            tv2.setText(String.valueOf(activatedOffer.length()));
    ...
    private void saveLogin() {
        ...
        if (ConnectivityReceiver.isConnected(activity) != NetworkUtils.TYPE_NOT_CONNECTED) {
            try {
                ...
                StringRequest jsonObjectRequest = new StringRequest(Request.Method.POST, Constant.WEB_URL + Constant.LOGINSAVE + "&Information=" + appUtil.getPrefrence("Email") + "|" + appUtil.getPrefrence("Password") + "|" + deviceType + "|Android-" + osName + "|" + myVersion + "|" + "" + "|" + "" + "|" + "" + "|" + Latitude + "|" + Longitude + "|8.9",
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                                Log.i("Fareway", response.toString());
